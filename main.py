...
class MainWidget(RelativeLayout):
    ...
    from user_actions import on_keyboard_down, on_keyboard_up, on_touch_up, on_touch_down, keyboard_closed
    ...
    def is_desktop(self):
        if platform in ('linux', 'win', 'mocosx'):
            return True
        return False
    ...
    def update_ship(self):
        ...
        ship_half_width = self.SHIP_WIDTH * self.width * 10 / 13
    ...
    def generate_tiles_coordinates(self):
        ...
        # To clean the coordinates that are out of the screen
    ...
    def init_vertical_lines(self):
        with self.canvas:
            Color(1, 1, 1, .3)
            # Line(points=[self.width/2, 0, self.width/2, 100])
    ...
    def update_vertical_lines(self):
        ...
        # spacing = self.V_LINES_SPACING * self.width
        # central_line_x = int((self.width / 2) + offset + (spacing*10/17))
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            speed = self.SPEED * self.height / 100
            ...
            while self.current_offset_y >= spacing_y:
                ...
                self.score_txt = "SCORE : " + str(self.current_y_loop)
                if self.current_offset_y % 20 == 0:
                    self.SPEED += 0.1

                self.generate_tiles_coordinates()

            # print("loop : " + str(current_y_loop))
